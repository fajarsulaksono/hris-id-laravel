...
@section('title', 'Proses Bulanan Absensi - '.config('app.name'))

@section('content-header')
    <x-crud.page-header title="Proses Bulanan Absensi" subtitle="Lengkapi absen otomatis & hitung rekap per karyawan">
        <x-slot:actions>
